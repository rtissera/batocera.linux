...
# on x86/x86_64: force ES to run on kmsdrm
ifeq ($(BR2_PACKAGE_XSERVER_XORG_SERVER),y)
	BATOCERA_EMULATIONSTATION_PREFIX = SDL_VIDEO_EGL_DRIVER=/usr/lib/libEGL.so SDL_VIDEO_DRIVER=kmsdrm SDL_NOMOUSE=1 HOME=/userdata/system
